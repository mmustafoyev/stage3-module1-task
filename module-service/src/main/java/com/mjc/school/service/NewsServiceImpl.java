...
import com.mjc.school.repository.datasource.imp.AuthorImpl;
import com.mjc.school.repository.datasource.imp.NewsImpl;
...
//    private final NewsMapper newsMapper = NewsMapper.INSTANCE;
    ...
    private final DataSource dataSource2 = new NewsImpl();
